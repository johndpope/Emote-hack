...
# manim -pql broadcasting_example.py BroadcastingExample -r 1280,720
class BroadcastingExample(Scene):
    def construct(self):
        ...
        # Create Manim arrays
        latent_codes_array = IntegerArray(latent_codes.astype(int), v_buff=0.5, h_buff=1)
        speed_embeddings_array = IntegerArray(speed_embeddings.astype(int), v_buff=0.5)
        ...
        expanded_speed_embeddings_array = IntegerArray(expanded_speed_embeddings.astype(int), v_buff=0.5, h_buff=1)
        ...
        combined_features_array = IntegerArray(combined_features.astype(int), v_buff=0.5, h_buff=1)
